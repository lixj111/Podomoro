...
namespace TomatoClock
{
    public partial class Pomodoro:Form
    {
        ...
        public Pomodoro(Main main,Entity.Task task)
        {
            Main = main;
            Task = task;
            //label_task.Text = task.Title; 
...
        }
        ...
        private void Ring()
        {
            ...
            if (music_path == "")
            {
                ...
                music_path = Path.GetFullPath(filename);
            }
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(music_path);
            player.Play();
        }
        ...
        {
            Entity.TomatoData tomatoData = new Entity.TomatoData(Task.TaskId, DateTime.Now.Month, DateTime.Now.Day, Task.Title, Tomatoes, TaskTime, Task.Category);
            Add(tomatoData);
            this.Close();
            Main.Show();
        }
